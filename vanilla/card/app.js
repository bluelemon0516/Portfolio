...
const CARD_IMG = ['plant0', 'plant1', 'plant2', 'plant3', 'plant4', 'plant5', 'plant6', 'plant7', 'plant8', 'plant9', 'plant10', 'plant11', 'plant12', 'plant13', 'plant14', 'plant15', 'plant16', 'plant17', 'plant18', 'plant19', 'plant20', 'plant21', 'plant22', 'plant23', 'plant24'];
const BOARD_SIZE = 24;
...
const stageClearImg = document.getElementsByClassName("stage_clear")[0];
...
function makeCardDeck() {
    // 이미지는 25개인데 필요한 카드는 12개로 고정되어 있기 때문에 25개의 이미지 중 랜덤으로 12개를 뽑도록 구현
    let randomNumberArr = [];

    for (let i = 0; i < BOARD_SIZE / 2; i++) {
        // 랜덤 값 뽑기
        let randomNumber = getRandom(25, 0);
...
// 카드 화면에 세팅
const gameBoard = document.getElementsByClassName("game_stage")[0];
...
function showGameResult() {
    ...
    <h1 class="modal_content_title">
        게임 종료!
    </h1>
    <span class="modal_content_stage">
        기록 : <strong>STAGE ${stage}</strong>
    </span>
    <p class="modal_content_desc">
        ${resultText}
    </p>
    `;
...
// 모달창 닫으면 게임 재시작
const modalTitle = document.getElementsByClassName("modal_content_title")[0];
const modalCloseButton = document.getElementsByClassName("modal_close")[0];
...
const playerTime = document.getElementsByClassName("menu_time")[0];
const playerStage = document.getElementById("player_stage");
